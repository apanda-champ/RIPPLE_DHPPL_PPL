...
if __name__ == '__main__':
    ...
    parser.add_argument("--preference_horizon", default=3, type=int)
    ...
    config = dict(
        ...
        # Algorithm config
        algo=dict(
            # FIX: removed add_bc_loss from here — PPL.train() does not use
            # the PVPTD3 extra_config flag system for this; it reads
            # bc_loss_weight directly and adds bc_loss when weight > 0.
